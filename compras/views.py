        ...
        if form.is_valid() and formset.is_valid():
            try:
                with transaction.atomic():
                    ...
                    compra.total = 0  # Los triggers actualizarán este valor
                    compra.save()
                    
                    # 2. Procesar detalles (los triggers actualizarán automáticamente totales y stock)
                    ...
                    # 3. Si es crédito, crear y generar cuotas 
